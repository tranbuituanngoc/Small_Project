...
class HotelRequest extends FormRequest
{
    public function rules(): array
    {
        if ($this->isMethod('post')) {
            ...
            return [
                ...
                'fax' => ['required', 'string', 'size:25', 'regex:/^[0-9]+$/'],
            ...
            return [
                'name' => ['sometimes', 'string', 'max:255', 'unique:hotels'],
                'hotel_code' => ['sometimes', 'string', 'max:255', 'unique:hotels'],
    ...
    public function messages(): array
    {
        return [
            ...
            'fax.size' => 'Fax must be 25 characters',
